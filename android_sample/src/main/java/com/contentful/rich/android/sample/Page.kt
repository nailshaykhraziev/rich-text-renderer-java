...
val PAGES = mutableListOf(
    ...
    Page(
        ...
        document = CDARichDocument().addAll(
            CDARichBlock().addAll(
                text("Quotes from "),
                text("Famous", listOf(CDARichMarkBold())),
                text(" People", listOf(CDARichMarkItalic()))
            ),
            CDARichQuote().addAll(
                text("You know you’re in love when you can’t fall asleep because reality is finally better than your dreams."),
                text("- Dr. Suess", listOf(CDARichMarkItalic()))
            ),
            CDARichQuote().addAll(
                text("I’m selfish, impatient and a little insecure. I make mistakes, I am out of control and at times hard to handle. But if you can’t handle me at my worst, then you sure as hell don’t deserve me at my best."),
                text("- Marilyn Monroe", listOf(CDARichMarkItalic()))
            ),
            CDARichQuote().addAll(
                text("Twenty years from now you will be more disappointed by the things that you didn’t do than by the ones you did do."),
                text("- Mark Twain", listOf(CDARichMarkItalic()))
            )
        )

    ),
    Page(
        name = "Links", document = CDARichDocument().addAll(
            CDARichParagraph().addAll(
                ...
                CDARichHyperLink("https://www.google.com/search?hl=en&site=imghp&tbm=isch&source=hp&q=cats")
                    .addAll(text("Hyperlink to cats")),
                text("Second Text"),
                CDARichHyperLink("https://github.com/contentful/contentful.java")
                    .addAll(text("OMEGA LUL")),
                text("Third Text"),
                CDARichHyperLink("https://www.google.com/search?hl=en&site=imghp&tbm=isch&source=hp&q=fish")
                    .addAll(text("Hyperlink to fish")),
            ),
            text("Normal Text"),
            CDARichHyperLink("https://www.google.com/search?hl=en&site=imghp&tbm=isch&source=hp&q=cats")
                .addAll(text("Hyperlink to cats")),
...
fun text(name: String, marks: List<CDARichMark> = listOf()) = CDARichText(name, marks)
